...
public class Main {
    ...
    private static final String FIRESTORE_URL = "https://mmi-stundenplan-bot.firebaseio.com";
    ...
    public static void main(String[] args) {
        ...
        Logger logger = LoggerFactory.getLogger("ScheduleWriter");

        logger.info("Writing schedule entries to firestore at {}", FIRESTORE_URL);
        Schedule.resolveScheduleEntries(calendar_uri).forEach(scheduleEntry ->
        {
            logger.debug("Writing schedulEentry {}", scheduleEntry);
        ...
        logger.info("Done writing scheduleEntries.");
    }
